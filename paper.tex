...
contribute a large chunk of that, especially for nqueens because that seems like a much
larger improvement than the serial optimizations applied to parallel program alone (when we tested).
